...
{
    public class PartnerziesController : Controller
    {
        private readonly FirmaContext _context;

        public PartnerziesController(FirmaContext context)
        {
            _context = context;
        }
        ...
        // GET: Partnerzies/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Partnerzies/Create
