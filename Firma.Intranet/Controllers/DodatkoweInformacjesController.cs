...
{
    public class DodatkoweInformacjesController : Controller
    {
        private readonly FirmaContext _context;

        public DodatkoweInformacjesController(FirmaContext context)
        {
            _context = context;
        }

        // GET: DodatkoweInformacjes
        ...
        // GET: DodatkoweInformacjes/Details/5
        ...
        // GET: DodatkoweInformacjes/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DodatkoweInformacjes/Create
        ...
        // GET: DodatkoweInformacjes/Edit/5
        ...
        // POST: DodatkoweInformacjes/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: DodatkoweInformacjes/Delete/5
        ...
        // POST: DodatkoweInformacjes/Delete/5
